...
namespace dz6.Tests
{
    class HomeworkOnVariablesTests
    {
        ...
        public void VariablesTest1(double a, double b, double expected)
        {
        ...
        public void VariablesTest2(int a, int b, int[] expected)
        {
        ...
        public void VariablesTest3(int a, int b, int c, double expected)
        {
        ...
        public void VariablesTest4(int x1, int y1, int x2, int y2, string expected)
        {
